"""
May 19 Challenge - 901. Online Stock Span
...
class StockSpanner(object):
    ...
    def next(self, price):
        ...
        :rtype: int
        """
        num_stocks_smaller = 1
        while self.stack and self.stack[-1][0] <= price:
            num_stocks_smaller += self.stack.pop()[1]

        self.stack.append((price, num_stocks_smaller))

        return num_stocks_smaller
